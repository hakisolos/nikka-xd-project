...
$root.groupproto = (function () {
	...
	groupproto.SenderKeyDistributionMessage = (function () {
		...
		SenderKeyDistributionMessage.fromObject = function fromObject(object) {
			...
			if (object.chainKey != null)
				if (typeof object.chainKey === 'string') $util.base64.decode(object.chainKey, (message.chainKey = $util.newBuffer($util.base64.length(object.chainKey))), 0);
				else if (object.chainKey.length) message.chainKey = object.chainKey;
			if (object.signingKey != null)
				if (typeof object.signingKey === 'string') $util.base64.decode(object.signingKey, (message.signingKey = $util.newBuffer($util.base64.length(object.signingKey))), 0);
				else if (object.signingKey.length) message.signingKey = object.signingKey;
			return message;
		};
	...
	groupproto.SenderChainKey = (function () {
		...
		SenderChainKey.fromObject = function fromObject(object) {
			...
			if (object.iteration != null) message.iteration = object.iteration >>> 0;
			if (object.seed != null)
				if (typeof object.seed === 'string') $util.base64.decode(object.seed, (message.seed = $util.newBuffer($util.base64.length(object.seed))), 0);
	...
	groupproto.SenderSigningKey = (function () {
		...
		SenderSigningKey.fromObject = function fromObject(object) {
			...
			if (object['public'] != null)
				if (typeof object['public'] === 'string') $util.base64.decode(object['public'], (message['public'] = $util.newBuffer($util.base64.length(object['public']))), 0);
				else if (object['public'].length) message['public'] = object['public'];
			if (object['private'] != null)
				if (typeof object['private'] === 'string') $util.base64.decode(object['private'], (message['private'] = $util.newBuffer($util.base64.length(object['private']))), 0);
